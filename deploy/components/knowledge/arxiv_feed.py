...
ARXIV_DIR = Path(os.environ.get("KNOWLEDGE_DIR", "/opt/agent-stack/knowledge")) / "arxiv_data"
...
def save_paper_to_wiki(paper_id, wiki_dir, db_path):
    ...
    raw_dir = Path(os.environ.get("KNOWLEDGE_DIR", "/opt/agent-stack/knowledge")) / "raw"
...
def migrate_from_arxiv_sanity():
    ...
    old_db = os.environ.get("ARXIV_SANITY_DB", "/opt/arxiv-sanity-lite/data/papers.db")
