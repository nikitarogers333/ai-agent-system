...
Scans /root/projects/ for .md files (max depth 2), skips symlinks and .bak files,
...
GLOBAL_MD = Path(os.environ.get("GLOBAL_MD", "/root/GLOBAL.md"))
...
def scan_project_files():
    """Scan /root/projects/ for .md files at max depth 2, skipping symlinks and .bak files."""
    files = []
    ...
    for item in sorted(PROJECTS_DIR.iterdir()):
        ...
        # Depth 1: .md files directly in /root/projects/<project>/
